    ...
    <Container className="py-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-bold text-gray-800 mb-2">My Carts</h1>
            <p className="text-lg text-gray-600">Manage your active shopping carts</p>
          </div>
          <Button
          ...
          >
            ...
            {isCreatingCart ? 'Creating...' : 'Create New Cart'}
          </Button>
        </div>
