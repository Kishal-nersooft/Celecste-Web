...
interface CategoryContextType {
  ...
  setLastVisitedCategory: (categoryId: number | null, isDeals?: boolean) => void;
...
export const CategoryProvider: React.FC<CategoryProviderProps> = ({ children }) => {
  ...
  }, [pathname, categoryState.lastVisitedCategory, categoryState.lastVisitedIsDeals]);

  const setSelectedCategory = (categoryId: number | null, isDeals: boolean = false) => {
    setCategoryState(prev => ({
      ...prev,
  ...
  const setLastVisitedCategory = (categoryId: number | null, isDeals: boolean = false) => {
    setCategoryState(prev => ({
      ...prev,
  ...
  const restoreLastVisitedCategory = () => {
