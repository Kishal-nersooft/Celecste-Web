    ...
    const loadDefaultAddress = async () => {
      try {
        ...
        if (savedAddressId && savedAddress) {
          console.log('🔄 Loading address from localStorage:', { savedAddressId, savedAddress });
          setAddressId(parseInt(savedAddressId));
          setSelectedLocation(savedAddress);
          console.log('✅ Address loaded from localStorage - Address ID:', parseInt(savedAddressId));
        }
        ...
        if (addresses && addresses.length > 0) {
          ...
          console.log('💾 Address saved to localStorage:', { id: defaultAddr.id, address: defaultAddr.address });
        } else {
